...
if (env('REDIS_SERVERS', false)) {
    $redisDefaults = ['host' => '127.0.0.1', 'port' => '8080', 'database' => '0', 'password' => null];
    $redisServers = explode(',', trim(env('REDIS_SERVERS', '127.0.0.1:8080'), ','));
...
return [
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'host'           => $mysql_host,
            'database'       => env('DB_DATABASE', 'kitapyigini'),
